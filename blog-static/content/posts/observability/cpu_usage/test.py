...
import sys;import site;import functools;sys.argv[0] = '/nix/store/az8cga3nq065w10aifl3f9b7ix4319z4-bcc-0.24.0/share/bcc/tools/runqlat';functools.reduce(lambda k, p: site.addsitedir(p, k), ['/nix/store/az8cga3nq065w10aifl3f9b7ix4319z4-bcc-0.24.0/lib/python3.10/site-packages','/nix/store/4m8jngp1d8z46ghgahayvzyvvdljwh3j-python3.10-netaddr-0.8.0/lib/python3.10/site-packages'], site._init_pathinfo());
from bcc import BPF
...
# code substitutions
has_field = BPF.kernel_struct_has_field(b'task_struct', b'__state')
print("has_field: %d" % has_field)
